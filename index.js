const sessionName = "Ruang-Curhat";
const donet = "Codex by OSISMPK SMKN 17";
const owner = ["6289682116872"];
const {
...
async function startHisoka() {
  ...
  client.ev.on("connection.update", async (update) => {
    ...
    if (connection === "close") {
      ...
      console.log(color("Codex By OSISMPK17", "yellow"));
      client.sendMessage(owner + "@s.whatsapp.net", {
        text: `Bot started!\n\nrunning on KepinB3tcode-Machine\n${donet}`,
      });
    }
